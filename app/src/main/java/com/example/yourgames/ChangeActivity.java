...
public class ChangeActivity extends AppCompatActivity {
    ...
    private void ChangeCompany(View view) {
        ...
        DocumentReference documentReference = db.collection("Companhias").document(user_ID);
        documentReference.set(change).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void unused) {
                Log.d("db_successful", "Dados salvos com sucesso");
    ...
    private void ChangePhone(View view) {
        ...
        DocumentReference documentReference = db.collection("Contatos").document(user_ID);
        documentReference.set(change).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void unused) {
                Log.d("db_successful", "Dados salvos com sucesso");
